  ...
  @extends ('project1/front/layout/default')
  @section ('content')
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-sm-6 text-center">
						<div class="featured">
							<a href="#" class="featured-img" style="background-image: url({{URL::to('')}}/public/assets/images/men.jpg);"></a>
							<div class="desc">
					...
					<div class="col-sm-6 text-center">
						<div class="featured">
							<a href="#" class="featured-img" style="background-image: url({{URL::to('')}}/public/assets/images/women.jpg);"></a>
							<div class="desc">
